...
updatePassing = F
#name of heatmap pdf
pdfName = 'output_pw/gsea_PAIR_important_genes.pdf'
savePlot = T
...
##dependencies
load('data_intermediate//pw_uniq2gsea_results.save')
...
get_important_genes(res_10a_v_7, sub('PAIR', '10a_v_7', pdfName))
get_important_genes(res_10a_v_231, sub('PAIR', '10a_v_231', pdfName))
get_important_genes(res_7_v_231, sub('PAIR', '7_v_231', pdfName))
