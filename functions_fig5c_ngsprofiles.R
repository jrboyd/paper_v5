...
load('data_raw/mycounts_data.save')#load old counts just to ensure colnames of new counts are in same order for compatibility
load('data_raw/my_fe_corrected.save')
my_fe = my_fe[,colnames(markData_4me3_4ac)]
