...
updatePassing = F
#name of heatmap pdf
pdfName = 'output_pw/gsea_uniquely_enriched.pdf'
savePlot = T
...
##dependencies
load(file = 'data_intermediate/pw_uniquely.save')
...
plot_uniquely = function(uniquely_K4_membership){
...
res_10a_v_7 = plot_uniquely(uniq_10a_v_7)
res_10a_v_231 = plot_uniquely(uniq_10a_v_231)
res_7_v_231 = plot_uniquely(uniq_7_v_231)
if(savePlot) dev.off()

save(res_10a_v_7, res_10a_v_231, res_7_v_231, file = 'data_intermediate/pw_uniq2gsea_results.save')
